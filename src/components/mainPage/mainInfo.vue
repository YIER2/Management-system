<template>
    <div class="content">
        <Row>
            ...
            <div class="logo" :style="{backgroundImage:'url(http://39.106.106.150/'+logoUrl+')'}">
            ...
            <Button type="primary" class="downs"><a :href="versionUrl" style="color: #ffffff!important;">下载test客户端</a></Button>
            </Col>
...
<script>
    export default {
        ...
        mounted() {
            this.getComInfo();
            this.versionUrl = 'http://39.106.106.150/download/windows/yongegetest-win-0.8.0.exe'
        }
    }
</script>
