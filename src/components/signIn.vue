<template>
    <div>
        ...
        <div class="mains">
            <div class="content">
                <div class="tittle-lv1">注册test客户端</div>
                <Form :model="formRight" :label-width="100" :rules="ruleValidate" @keyup.enter="signin">
                    ...
                    <div class="mTop">
                        ...
                        <FormItem label="姓名" prop="fullname">
                            <Input v-model="formRight.fullname" placeholder="请填写test客户端管理员的姓名"></Input>
                        </FormItem>
                    ...
                    <div style="text-align:center;color:#ccc;margin-top: 10px;">
                        <CheckboxGroup>
                            <Checkbox v-model="agree" label="我同意并遵守《test客户端服务协议》"></Checkbox>
