...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //获取客户权限
            getUserQx(){
                console.log('用户信息222222222222222222', this.curMember);
                this.$http.get(this.$api.ADD_USER + '/' + this.curMember ).then(res=>{
                    const qx = res.data.data.permissions;
                    const temArr = [];
        ...
        watch: {
            ...
            'curMember':function(val){
                console.log('curMember'+val)
